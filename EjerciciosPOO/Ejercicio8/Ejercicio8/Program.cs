...
namespace ejercicio8
{
    ...
    public class Menu
    {
        ...
        public Menu(string[] opciones)
        {
            ...
            libros.Add(new Libro("El código Da Vinci", "Dan Brown"));
            libros.Add(new Libro("Las aventuras de Sherlock Holmes", "Arthur Conan Doyle"));
        }
        ...
        public string PrestarLibro(string tituloprestado, string persona)
        {
            ...
            if (!encontrado)
            {
                Console.WriteLine("El libro no está disponible para préstar o no existe.");
                return null;
